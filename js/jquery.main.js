...
/*edit remove menu from below body place below form feild*/				
			/* this.fakeDropTarget = this.options.fakeDropInBody ? $('body') : this.fakeElement ;*/
				this.fakeDropTarget = this.options.fakeDropInBody ? $('.location-form') : this.fakeElement;
...
/*edit*/				/* this.hideDropdown(); */
			/* } */
/*edit new*/if(!clickedInsideSelect && !$("body").hasClass("nav-active")) {this.hideDropdown();}
		},
		onSelect: function() {
			this.hideDropdown();
			this.refresh();
		...
		createDropdown: function() {
			...
			if(this.options.fakeDropInBody) {
				/* edit remove inline absolute position */
				/*
this.dropdown.css({
					position: 'absolute',
					top: -9999
...
*/
/*edit new */this.dropdown.addClass("themenu");
			}
...
/* edit remove inline variable position*/
				/*
